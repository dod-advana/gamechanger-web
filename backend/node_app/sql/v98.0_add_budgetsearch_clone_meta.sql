SELECT setval('clone_meta_id_seq', (SELECT MAX(id) from clone_meta));
...
show_graph,clone_to_jupiter,show_tutorial,show_crowd_source,show_feedback,config,graph_module,main_view_module,search_bar_module,data_module)
...
FALSE,FALSE,FALSE,FALSE,FALSE,'{"esIndex": "gc_budgetsearch"}', 'simple/simpleGraphHandler', 'budgetSearch/budgetSearchMainViewHandler', 'budgetSearch/budgetSearchSearchBarHandler', 'budgetSearch/budgetSearchDataHandler');