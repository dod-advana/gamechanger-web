...
VALUES (8,'budgetSearch','simple/simpleSearchHandler','simple/simpleExportHandler','Budget Search','budgetSearch/budgetSearchTitleBarHandler',
'budgetSearch/budgetSearchNavigationHandler','budgetSearch/budgetSearchCardHandler',TRUE,'budgetsearch',TRUE,TRUE,TRUE,FALSE,
FALSE,FALSE,FALSE,TRUE,TRUE,'{"esindex": "gc_budgetsearch"}', 'simple/simpleGraphHandler', 'budgetSearch/budgetSearchTestMainViewHandler');