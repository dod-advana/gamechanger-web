...
$$ 
    ...
    "components": [
            ...
            "sub_components": [
                {
                    ...
                    "step_number": 5,
                    "step_text": "Each card shows you a document relevant to your query, with which you can now interact.",
                    "type": "display",
        ...
        {
            "component_name": "List View Tab",
            "step_number": 0,
            "step_text": "",
            "type": "button",
            "button_ID": "gcListViewTab",
            "click_button": true,
            "sub_components": [
                {
                    "component_name": "List View Card",
                    "step_number": 0,
                    "step_text": "",
                    "type": "display"
                }
        ...
        {
            "component_name": "Single Card View",
            "step_number": 0,
            "step_text": "",
            "type": "button",
            "button_ID": "gcSingleCardBtn",
            "click_button": true
        }
    ]
}';
...
$$ 
    ...
    "components": [
        ...
        },
        {
            "component_name": "List View Tab",
            "step_number": 2,
            "step_text": "The List View tab provides a summarized view of the search results.",
            "type": "button",
            "button_ID": "gcListViewTab",
            "click_button": true,
            "sub_components": [
                {
                    "component_name": "List View Card",
                    "step_number": 3,
                    "step_text": "Along with page hit count, keywords, and references, clicking on the document title pulls up the document preview.",
                    "type": "display",
                    "title": "CARD",
                    "test_A": true
                }
        ...
        },
        {
            "component_name": "Single Card View",
            "step_number": 4,
            "step_text": "Click this button to switch to the single card view.",
            "type": "button",
            "button_ID": "gcSingleCardBtn",
            "click_button": true,
            "title": "CARD",
