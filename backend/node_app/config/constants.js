...
module.exports = Object.freeze({
	...
	GAMECHANGER_ELASTIC_SEARCH_OPTS: {
		...
		protocol: 'https',
		host: 'vpc-gamechanger-iquxkyq2dobz4antllp35g2vby.us-east-1.es.amazonaws.com',
		port: '443',
		user: '',
		password: process.env.ELASTICSEARCH_PASSWORD_GAME_CHANGER,
	...
	EDA_ELASTIC_SEARCH_OPTS: {
		...
		port: '443',
		user: '',
		password: process.env.ELASTICSEARCH_PASSWORD_EDA,
		ca: process.env.GAMECHANGER_ELASTICSEARCH_CA_FILEPATH,
		index: 'gc_eda_2021_json',
