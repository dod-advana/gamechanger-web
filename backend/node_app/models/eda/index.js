...
let eda_sequelize = new Sequelize(
	constants.POSTGRES_CONFIG.databases.eda.database,
	constants.POSTGRES_CONFIG.databases.eda.username,
	constants.POSTGRES_CONFIG.databases.eda.password,
	constants.POSTGRES_CONFIG.databases.eda
);
