	...
	writeCsvData(stringifier, data) {
		if (data && data.docs && data.docs.length > 0) {
			const header = [
				...
				'Contract Number (U)',
				'Page Count (U)',
				'Issuing Organization (U)',
				// '',
				// '',
				// 'CLINS',
				// 'Prod or Svc',
				'PCS Code (FPDS-NG) (CUI//SP-PROCURE)',
				'PSC Description (FPDS-NG) (CUI//SP-PROCURE)',
				// 'Base',
				// 'Type',
				'Obligated Amount (CUI//SP-PROCURE)',
				'Clin Number (CUI//SP-PROCURE)',
				'Unit (CUI//SP-PROCURE)',
				'Unit Price (CUI//SP-PROCURE)',
				'Amount (CUI//SP-PROCURE)',
				'Purchase Request Number (CUI//SP-PROCURE)',
				// 'Supply Services',
				'PSC Code (CUI//SP-PROCURE)',
				'NAICS (CUI//SP-PROCURE)',
