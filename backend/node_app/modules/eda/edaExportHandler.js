	...
	writeCsvData(stringifier, data) {
		if (data && data.docs && data.docs.length > 0) {
			const header = [
				...
				'(U) Contract Number',
				'(U) Page Count',
				'(U) Issuing Organization',
				// '',
				// '',
				// 'CLINS',
				// 'Prod or Svc',
				'(CUI//SP-PROCURE) PCS Code (FPDS-NG)',
				'(CUI//SP-PROCURE) PSC Description (FPDS-NG)',
				// 'Base',
				// 'Type',
				'(CUI//SP-PROCURE) Obligated Amount',
				'(CUI//SP-PROCURE) Clin Number',
				'(CUI//SP-PROCURE) Unit',
				'(CUI//SP-PROCURE) Unit Price',
				'(CUI//SP-PROCURE) Amount',
				'(CUI//SP-PROCURE) Purchase Request Number',
				// 'Supply Services',
				'(CUI//SP-PROCURE) PSC Code',
				'(CUI//SP-PROCURE) NAICS',
