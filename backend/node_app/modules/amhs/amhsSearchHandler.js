...
class AmhsSearchHandler extends SearchHandler {
	constructor(opts = {}) {
	...
	async searchHelper(req, userId, storeHistory) {
		...
		try {
			...
			try {
				...
				const auxSearchFields = constants.AMHS_ELASTIC_SEARCH_OPTS.auxSearchFields;
				const auxRetrieveFields = constants.AMHS_ELASTIC_SEARCH_OPTS.auxRetrieveFields;
