...
class CDOSearchHandler extends SearchHandler {
	constructor(opts = {}) {
	...
	async searchHelper(req, userId, storeHistory) {
		...
		try {
			...
			const clientObj = {esClientName: 'gamechanger', esIndex: constants.CDO_ELASTIC_SEARCH_OPTS.index};
...
module.exports = CDOSearchHandler;
