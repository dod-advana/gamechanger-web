...
const ORGDOCMAP = {
	...
	'US Navy': ['OPNAVNOTE', 'SECNAVNOTE', 'OPNAVINST', 'SECNAVINST'],
	'US Navy Reserve': ['COMNAVRESFORCOMINST', 'COMNAVRESFORCOMNOTE', 'RESPERSMAN'],
	'US Navy Medicine': ['NAVMED', 'BUMEDNOTE', 'BUMEDINST'],
};
