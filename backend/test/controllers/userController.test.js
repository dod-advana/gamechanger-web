	...
	describe('#getUserData', () => {
		...
		it('should return fake user data for a new user', async (done) => {
			...
			try {
				...
				const expected = {'api_key': '', 'export_history': [],'pdf_opened': [], 'favorite_documents': [], 'favorite_searches': [], 'notifications': {}, 'search_history': [], 'user_id': '27d1ca9e10b731476b7641eae2710ac0'};
				assert.deepStrictEqual(resMsg, expected);
				done();
			} catch (e) {
				assert.fail(e);
