...
describe('SearchUtility', function () {
	...
	describe('#getElasticsearchQuery', () => {
		it('should return an es query given parsedQuery and defaults', () => {
			...
			const expected = {"_source": {"includes": ["pagerank_r", "kw_doc_score_r", "orgs_rs", "topics_rs"]}, "aggregations": {"doc_org_aggs": {"terms": {"field": "display_org_s", "size": 10000}}, "doc_type_aggs": {"terms": {"field": "display_doc_type_s", "size": 10000}}}, "from": 0, "highlight": {"boundary_scanner": "word", "fields": {"display_title_s.search": {}, "filename.search": {}, "keyw_5": {}}, "fragment_size": 10, "fragmenter": "simple", "require_field_match": false, "type": "unified"}, "query": {"bool": {"filter": [{"term": {"is_revoked_b": "false"}}], "minimum_should_match": 1, "must": [], "should": [{"nested": {"inner_hits": {"_source": false, "from": 0, "highlight": {"fields": {"paragraphs.par_raw_text_t": {"fragment_size": 270, "number_of_fragments": 1, "type": "plain"}, "paragraphs.par_raw_text_t.gc_english": {"fragment_size": 270, "number_of_fragments": 1, "type": "plain"}}, "fragmenter": "span"}, "size": 5, "stored_fields": ["paragraphs.page_num_i", "paragraphs.par_raw_text_t"]}, "path": "paragraphs", "query": {"bool": {"should": [{"query_string": {"analyzer": "gc_english","default_field": "paragraphs.par_raw_text_t.gc_english","default_operator": "and","fuzziness": "AUTO","fuzzy_max_expansions": 100,"query": "artificial intelligence"}}]}}}}, {"wildcard": {"keyw_5": {"boost": 2, "value": "*artificial intelligence*"}}}, {"wildcard": {"display_title_s.search": {"boost": 8, "value": "*artificial intelligence*"}}}, {"wildcard": {"filename.search": {"boost": 4, "value": "*artificial intelligence*"}}}, {"match": {"display_title_s.search": "artificial intelligence"}}]}}, "size": 20, "sort": [{"_score": {"order": "desc"}}], "stored_fields": ["filename", "title", "page_count", "doc_type", "doc_num", "ref_list", "id", "summary_30", "keyw_5", "p_text", "type", "p_page", "display_title_s", "display_org_s", "display_doc_type_s", "is_revoked_b", "access_timestamp_dt", "publication_date_dt", "crawler_used_s", "download_url_s", "source_page_url_s", "source_fqdn_s"], "track_total_hits": true}
			assert.deepStrictEqual(actual, expected);
		});
