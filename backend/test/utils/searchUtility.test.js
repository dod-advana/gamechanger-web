...
;
	...
	describe('#queryOneDocQA', function () {
		...
		it('should take in the filename of an ES result, re-query ES to get the entire doc, and return the expanded beginning of the doc', async () => {
			const tmpOpts = {
				...opts,
				constants: {env: { GAME_CHANGER_OPTS: {allow_daterange: false}}},
				dataApi: {
			...
			const filename = 'ARMY DIR 2018-18.pdf';
			const minLength = 350;
			const actual = await target.queryOneDocQA(filename, userId, minLength);
			const expected = ['', 'MEMORANDUM FOR SEE DISTRIBUTION ', 'SUBJECT : Army Directive 2018-18 ( Army Artificial Intelligence Task Force in Support of the Department of Defense Joint Artificial Intelligence Center ) ', '1 . References : ', 'a . Memorandum , Deputy Secretary of Defense , June 27 , 2018 , subject : Establishment of the Joint Artificial Intelligence Center .', 'b . 2018 Department of Defense Artificial Intelligence Strategy , June 27 , 2018 .', '2 . The 2018 National Defense Strategy articulates advancements in artificial intelligence ( AI ) that will present strategic opportunities and risks .The Department of Defense ( Do D ) has directed the establishment of the Joint Artificial Intelligence Center ( JAIC ) under the Do D Chief Information Officer .The JAIC serves as the accelerator and synchronizer of Do D AI activities .The Do D Chief Information Officer is seeking partnership with the Military Services as sponsors in three locations : the Pentagon , the National Capital Region , and Pittsburgh , PA .Large scale efforts or clusters of closely related joint urgent challenges will be identified as National Military Initiatives and will be executed in partnership across Do D . These efforts serve as opportunities for synergy among efforts the respective stakeholders may initiate to achieve their statutory responsibilities .', '3 . The Army is establishing the Army AI Task Force ( A AI TF ) that will narrow an existing AI capability gap by leveraging current technological applications to enhance our warfighters , preserve peace , and , if required , fight to win .', '4 . The purpose of this directive is to establish a scalable A AI TF under U.S . Army Futures Command ( AFC ) consisting of hand selected Army personnel with specific skillsets to lead Army AI efforts and support Do D projects , principally based at Carnegie Mellon University .The end state is an empowered team that rapidly integrates and synchronizes AI activities across the Army enterprise and Do D ’s National Military Initiatives .', '5 . A AI TF leaders and talent have been selected to start work immediately in coordination with JAIC ’s efforts .The A AI TF will establish its footprint in accordance with Carnegie Mellon ’s 90 day occupation plan , formally organize under AFC , develop and then implement an Army AI Strategy , and initiate pilot projects in coordination with S E C R E T AR Y O F T H E A R M Y W A S H I N G T O N '];
			assert.deepStrictEqual(actual, expected);
		});
	});
	...
	describe('#getQAContext', function () {
		...
		it('wrapper function that should take in searchResults, QA parameters, and return context', async () => {
			...
			const maxLength = 3000;
			const qaQuery = target.phraseQAQuery(qaSearchText, qaSearchTextList, maxLength, userId);
			const searchResults = await target.dataLibrary.queryElasticSearch(esClientName, esIndex, qaQuery, userId);
			const maxDocContext = 3;
			const maxParaContext = 3;
			const scoreThreshold = 100;
			const minLength = 350;
			const actual = await target.getQAContext(searchResults, userId, maxDocContext, maxParaContext, minLength, maxLength, scoreThreshold);
			//const expected = [];
			const expected = [{"docId": "ARMY DIR 2018-18.pdf_0", "filename": "ARMY 2018-18 ARMY ARTIFICIAL INTELLIGENCE TASK FORCE IN SUPPORT OF THE DEPARTMENT OF DEFENSE JOINT ARTIFICIAL INTELLIGENCE CENTER", "parId": 0, "text": " MEMORANDUM FOR SEE DISTRIBUTION  SUBJECT : Army Directive 2018-18 ( Army Artificial Intelligence Task Force in Support of the Department of Defense Joint Artificial Intelligence Center )  1 . References :  a . Memorandum , Deputy Secretary of Defense , June 27 , 2018 , subject : Establishment of the Joint Artificial Intelligence Center . b . 2018 Department of Defense Artificial Intelligence Strategy , June 27 , 2018 . 2 . The 2018 National Defense Strategy articulates advancements in artificial intelligence ( AI ) that will present strategic opportunities and risks .The Department of Defense ( Do D ) has directed the establishment of the Joint Artificial Intelligence Center ( JAIC ) under the Do D Chief Information Officer .The JAIC serves as the accelerator and synchronizer of Do D AI activities .The Do D Chief Information Officer is seeking partnership with the Military Services as sponsors in three locations : the Pentagon , the National Capital Region , and Pittsburgh , PA .Large scale efforts or clusters of closely related joint urgent challenges will be identified as National Military Initiatives and will be executed in partnership across Do D . These efforts serve as opportunities for synergy among efforts the respective stakeholders may initiate to achieve their statutory responsibilities . 3 . The Army is establishing the Army AI Task Force ( A AI TF ) that will narrow an existing AI capability gap by leveraging current technological applications to enhance our warfighters , preserve peace , and , if required , fight to win . 4 . The purpose of this directive is to establish a scalable A AI TF under U.S . Army Futures Command ( AFC ) consisting of hand selected Army personnel with specific skillsets to lead Army AI efforts and support Do D projects , principally based at Carnegie Mellon University .The end state is an empowered team that rapidly integrates and synchronizes AI activities across the Army enterprise and Do D ’s National Military Initiatives . 5 . A AI TF leaders and talent have been selected to start work immediately in coordination with JAIC ’s efforts .The A AI TF will establish its footprint in accordance with Carnegie Mellon ’s 90 day occupation plan , formally organize under AFC , develop and then implement an Army AI Strategy , and initiate pilot projects in coordination with S E C R E T AR Y O F T H E A R M Y W A S H I N G T O N "}, {"docId": "OMBM M-20-29.pdf_0", "filename": "OMBM M-20-29 R & D Guidance", "parId": 0, "text": " MEMORANDUM FOR SEE DISTRIBUTION  SUBJECT : Army Directive 2018-18 ( Army Artificial Intelligence Task Force in Support of the Department of Defense Joint Artificial Intelligence Center )  1 . References :  a . Memorandum , Deputy Secretary of Defense , June 27 , 2018 , subject : Establishment of the Joint Artificial Intelligence Center . b . 2018 Department of Defense Artificial Intelligence Strategy , June 27 , 2018 . 2 . The 2018 National Defense Strategy articulates advancements in artificial intelligence ( AI ) that will present strategic opportunities and risks .The Department of Defense ( Do D ) has directed the establishment of the Joint Artificial Intelligence Center ( JAIC ) under the Do D Chief Information Officer .The JAIC serves as the accelerator and synchronizer of Do D AI activities .The Do D Chief Information Officer is seeking partnership with the Military Services as sponsors in three locations : the Pentagon , the National Capital Region , and Pittsburgh , PA .Large scale efforts or clusters of closely related joint urgent challenges will be identified as National Military Initiatives and will be executed in partnership across Do D . These efforts serve as opportunities for synergy among efforts the respective stakeholders may initiate to achieve their statutory responsibilities . 3 . The Army is establishing the Army AI Task Force ( A AI TF ) that will narrow an existing AI capability gap by leveraging current technological applications to enhance our warfighters , preserve peace , and , if required , fight to win . 4 . The purpose of this directive is to establish a scalable A AI TF under U.S . Army Futures Command ( AFC ) consisting of hand selected Army personnel with specific skillsets to lead Army AI efforts and support Do D projects , principally based at Carnegie Mellon University .The end state is an empowered team that rapidly integrates and synchronizes AI activities across the Army enterprise and Do D ’s National Military Initiatives . 5 . A AI TF leaders and talent have been selected to start work immediately in coordination with JAIC ’s efforts .The A AI TF will establish its footprint in accordance with Carnegie Mellon ’s 90 day occupation plan , formally organize under AFC , develop and then implement an Army AI Strategy , and initiate pilot projects in coordination with S E C R E T AR Y O F T H E A R M Y W A S H I N G T O N "}, {"docId": "AGO 1987-26.pdf_0", "filename": "AGO 1987-26 HQDA GENERAL ORDERS: MULTIPLE TITLES", "parId": 0, "text": " MEMORANDUM FOR SEE DISTRIBUTION  SUBJECT : Army Directive 2018-18 ( Army Artificial Intelligence Task Force in Support of the Department of Defense Joint Artificial Intelligence Center )  1 . References :  a . Memorandum , Deputy Secretary of Defense , June 27 , 2018 , subject : Establishment of the Joint Artificial Intelligence Center . b . 2018 Department of Defense Artificial Intelligence Strategy , June 27 , 2018 . 2 . The 2018 National Defense Strategy articulates advancements in artificial intelligence ( AI ) that will present strategic opportunities and risks .The Department of Defense ( Do D ) has directed the establishment of the Joint Artificial Intelligence Center ( JAIC ) under the Do D Chief Information Officer .The JAIC serves as the accelerator and synchronizer of Do D AI activities .The Do D Chief Information Officer is seeking partnership with the Military Services as sponsors in three locations : the Pentagon , the National Capital Region , and Pittsburgh , PA .Large scale efforts or clusters of closely related joint urgent challenges will be identified as National Military Initiatives and will be executed in partnership across Do D . These efforts serve as opportunities for synergy among efforts the respective stakeholders may initiate to achieve their statutory responsibilities . 3 . The Army is establishing the Army AI Task Force ( A AI TF ) that will narrow an existing AI capability gap by leveraging current technological applications to enhance our warfighters , preserve peace , and , if required , fight to win . 4 . The purpose of this directive is to establish a scalable A AI TF under U.S . Army Futures Command ( AFC ) consisting of hand selected Army personnel with specific skillsets to lead Army AI efforts and support Do D projects , principally based at Carnegie Mellon University .The end state is an empowered team that rapidly integrates and synchronizes AI activities across the Army enterprise and Do D ’s National Military Initiatives . 5 . A AI TF leaders and talent have been selected to start work immediately in coordination with JAIC ’s efforts .The A AI TF will establish its footprint in accordance with Carnegie Mellon ’s 90 day occupation plan , formally organize under AFC , develop and then implement an Army AI Strategy , and initiate pilot projects in coordination with S E C R E T AR Y O F T H E A R M Y W A S H I N G T O N "}]
			assert.deepStrictEqual(actual, expected);
		});
	});

	describe('#filterQAResults', function () {

		it('should remove any answers starting with [CLS]', () => {
			const tmpOpts = {
				...opts,
				constants: {env: { GAME_CHANGER_OPTS: {allow_daterange: false}}}
			};

			const shortenedResults = { answers: [ 'not assigned to Red Team billets', '[CLS] what is the red team [SEP] Agency or United States Strategic Command certified', '[CLS] what is the red team [SEP] – 14 ) in the individual ’ s chain of command will verify in writing the individual has been trained in accordance with the provisions of paragraphs 3 – 3 and 3 – 4a of this regulation. A copy of this certification will be maintained on file at the unit, available for inspection by any IG, oversight officer, or command inspector. Individual certification is valid for 3 years or until the certified individual is no longer involved in Red Team activities, whichever is sooner. Individual certification is held separate from unit certification and has no effect thereon. c. Nontrained personnel. When required, Red Team mission supervisors may augment the Red Team efforts with nontrained personnel, provided all nontrained personnel work under the direct supervision of trained and certified Red Team personnel. d. Refresher training. Personnel participating in Red Team activities will receive annual unit level refresher training and are required to renew individual certification every 3 years. e. Violation reporting. Any information gathered as “ data at rest ” ( DAR ) or “ data in motion ” will be processed in accordance with paragraph 2 – 7b of this regulation. f. Access for oversight. All Red Team personnel will cooperate fully with the Army and DOD GCs, intelligence oversight officers, and IGs in performing their necessary oversight responsibilities. 3 – 5. Red Team operations Red Team operations expose vulnerabilities by challenging an organization ’ s readiness and ability to protect information. Red Team activities focus on identifying an organization ’ s critical and classified information', 'The Red Team will use several support systems, each having a distinct methodology, to gather information guarded by the target and assess vulnerabilities in the target ’ s established defense mechanisms', 'a Do D Cyber Red Team' ], question: 'what is the red team' };
			const target = new SearchUtility(tmpOpts);
			const actual = target.filterQAResults(shortenedResults);
			const expected = { question: 'what is the red team', answers: [ 'not assigned to Red Team billets', 'The Red Team will use several support systems, each having a distinct methodology, to gather information guarded by the target and assess vulnerabilities in the target ’ s established defense mechanisms', 'a Do D Cyber Red Team' ] };
			assert.deepStrictEqual(actual, expected);
		});
	});
});
