...
describe('SearchUtility', function () {
	...
	describe('#getESSuggesterPresearchQuery()', function () {
		...
		it('should create the ElasticSearch suggester query from searchText', () => {
			...
			//const expected = [{'index': 'gamechanger'}, {'_source': ['filename'], 'query': {'bool': {'filter': [{'term': {'is_revoked_b': false}}], 'must': [{'wildcard': {'filename.search': {'boost': 1, 'rewrite': 'constant_score', 'value': '*MISSION*'}}}]}}, 'size': 2}, {'index': 'gamechanger'}, {'_source': ['title'], 'query': {'bool': {'filter': [{'term': {'is_revoked_b': false}}], 'must': [{'wildcard': {'title.search': {'boost': 1, 'rewrite': 'constant_score', 'value': '*MISSION*'}}}]}}, 'size': 2}, {'index': undefined}, {'aggs': {'search_query': {'aggs': {'user': {'terms': {'field': 'user_id', 'size': 3}}}, 'terms': {'field': 'search_query', 'min_doc_count': 5}}}, 'query': {'prefix': {'search_query': {'value': 'mission'}}}, 'size': 1}, {'index': undefined}, {'_source': {'includes': ['name', 'aliases', 'entity_type']}, 'query': {'prefix': {'name': {'value': 'mission'}}}, 'size': 2}];
	...
	describe('#getElasticsearchQuery', () => {
		...
		//	const expected = {'_source':{'includes':['pagerank_r','kw_doc_score_r','orgs_rs','topics_rs']},'stored_fields':['filename','title','page_count','doc_type','doc_num','ref_list','id','summary_30','keyw_5','p_text','type','p_page','display_title_s','display_org_s','display_doc_type_s','is_revoked_b','access_timestamp_dt','publication_date_dt','crawler_used_s','download_url_s','source_page_url_s','source_fqdn_s'],'from':0,'size':20,'aggregations':{'doc_type_aggs':{'terms':{'field':'display_doc_type_s','size':10000}},'doc_org_aggs':{'terms':{'field':'display_org_s','size':10000}}},'track_total_hits':true,'query':{'bool':{'must':[],'should':[{'nested':{'path':'paragraphs','inner_hits':{'_source':false,'stored_fields':['paragraphs.page_num_i','paragraphs.par_raw_text_t'],'from':0,'size':5,'highlight':{'fields':{'paragraphs.par_raw_text_t':{'fragment_size':270,'number_of_fragments':1,'type':'plain'},'paragraphs.par_raw_text_t.gc_english':{'fragment_size':270,'number_of_fragments':1,'type':'plain'}},'fragmenter':'span'}},'query':{'bool':{'should':[{'query_string':{'query':'artificial intelligence','default_field':'paragraphs.par_raw_text_t.gc_english','default_operator':'and','fuzzy_max_expansions':100,'fuzziness':'AUTO','analyzer':'gc_english'}}]}}}},{'wildcard':{'keyw_5':{'value':'*artificial intelligence*'}}},{'wildcard':{'title.search':{'value':'*artificial intelligence*','boost':4}}},{'wildcard':{'filename.search':{'value':'*artificial intelligence*','boost':4}}},{'multi_match':{'query':'artificial intelligence','fields':['title.search','filename.search'],'operator':'AND','type':'phrase','boost':2}}],'minimum_should_match':1,'filter':[{'term':{'is_revoked_b':'false'}}]}},'highlight':{'require_field_match':false,'fields':{'title.search':{},'keyw_5':{},'id':{},'filename.search':{}},'fragment_size':10,'fragmenter':'simple','type':'unified','boundary_scanner':'word'},'sort':[{'_score':{'order':'desc'}}]};
			const expected = {"_source":{"includes":["pagerank_r","kw_doc_score_r","orgs_rs","topics_rs"]},"stored_fields":["filename","title","page_count","doc_type","doc_num","ref_list","id","summary_30","keyw_5","p_text","type","p_page","display_title_s","display_org_s","display_doc_type_s","is_revoked_b","access_timestamp_dt","publication_date_dt","crawler_used_s","download_url_s","source_page_url_s","source_fqdn_s"],"from":0,"size":20,"aggregations":{"doc_type_aggs":{"terms":{"field":"display_doc_type_s","size":10000}},"doc_org_aggs":{"terms":{"field":"display_org_s","size":10000}}},"track_total_hits":true,"query":{"bool":{"must":[],"should":[{"nested":{"path":"paragraphs","inner_hits":{"_source":false,"stored_fields":["paragraphs.page_num_i","paragraphs.par_raw_text_t"],"from":0,"size":5,"highlight":{"fields":{"paragraphs.par_raw_text_t":{"fragment_size":270,"number_of_fragments":1,"type":"plain"},"paragraphs.par_raw_text_t.gc_english":{"fragment_size":270,"number_of_fragments":1,"type":"plain"}},"fragmenter":"span"}},"query":{"bool":{"should":[{"query_string":{"query":"artificial intelligence","default_field":"paragraphs.par_raw_text_t.gc_english","default_operator":"and","fuzzy_max_expansions":100,"fuzziness":"AUTO","analyzer":"gc_english"}}]}}}},{"wildcard":{"keyw_5":{"value":"*artificial intelligence*"}}},{"wildcard":{"display_title_s.search":{"value":"*artificial intelligence*","boost":6}}},{"multi_match":{"query":"artificial intelligence","fields":["display_title_s.search"],"operator":"AND","type":"phrase","boost":4}}],"minimum_should_match":1,"filter":[{"term":{"is_revoked_b":"false"}}]}},"highlight":{"require_field_match":false,"fields":{"display_title_s.search":{},"keyw_5":{},"id":{}},"fragment_size":10,"fragmenter":"simple","type":"unified","boundary_scanner":"word"},"sort":[{"_score":{"order":"desc"}}]}
...
;
	...
	describe('#makeBigramQueries', function () {
		...
		it('should take in the query broken into a list, the found alias, and create bigram queries for QA', () => {
			...
			const expected = {'docMustQueries': [{'wildcard': {'paragraphs.filename.search': {'boost': 15, 'value': 'what is'}}}, {'query_string': {'default_field': 'paragraphs.par_raw_text_t', 'default_operator': 'AND', 'fuzziness': 'AUTO', 'fuzzy_max_expansions': 100, 'query': 'what is'}}, {'wildcard': {'paragraphs.filename.search': {'boost': 15, 'value': 'is the'}}}, {'query_string': {'default_field': 'paragraphs.par_raw_text_t', 'default_operator': 'AND', 'fuzziness': 'AUTO', 'fuzzy_max_expansions': 100, 'query': 'is the'}}, {'wildcard': {'paragraphs.filename.search': {'boost': 15, 'value': 'the mission'}}}, {'query_string': {'default_field': 'paragraphs.par_raw_text_t', 'default_operator': 'AND', 'fuzziness': 'AUTO', 'fuzzy_max_expansions': 100, 'query': 'the mission'}}, {'wildcard': {'paragraphs.filename.search': {'boost': 15, 'value': 'mission of'}}}, {'query_string': {'default_field': 'paragraphs.par_raw_text_t', 'default_operator': 'AND', 'fuzziness': 'AUTO', 'fuzzy_max_expansions': 100, 'query': 'mission of'}}, {'wildcard': {'paragraphs.filename.search': {'boost': 15, 'value': 'of the'}}}, {'query_string': {'default_field': 'paragraphs.par_raw_text_t', 'default_operator': 'AND', 'fuzziness': 'AUTO', 'fuzzy_max_expansions': 100, 'query': 'of the'}}, {'wildcard': {'paragraphs.filename.search': {'boost': 15, 'value': 'the epa'}}}, {'query_string': {'default_field': 'paragraphs.par_raw_text_t', 'default_operator': 'AND', 'fuzziness': 'AUTO', 'fuzzy_max_expansions': 100, 'query': 'the epa'}}], 'docShouldQueries': [{'multi_match': {'fields': ['keyw_5^2', 'id^2', 'summary_30', 'paragraphs.par_raw_text_t'], 'operator': 'or', 'query': 'what is the mission of the epa'}}, {'multi_match': {'boost': 5, 'fields': ['summary_30', 'title', 'keyw_5'], 'query': 'what is', 'type': 'phrase'}}, {'multi_match': {'boost': 5, 'fields': ['summary_30', 'title', 'keyw_5'], 'query': 'is the', 'type': 'phrase'}}, {'multi_match': {'boost': 5, 'fields': ['summary_30', 'title', 'keyw_5'], 'query': 'the mission', 'type': 'phrase'}}, {'multi_match': {'boost': 5, 'fields': ['summary_30', 'title', 'keyw_5'], 'query': 'mission of', 'type': 'phrase'}}, {'multi_match': {'boost': 5, 'fields': ['summary_30', 'title', 'keyw_5'], 'query': 'of the', 'type': 'phrase'}}, {'multi_match': {'boost': 5, 'fields': ['summary_30', 'title', 'keyw_5'], 'query': 'the epa', 'type': 'phrase'}}], 'entityShouldQueries': [{'match_phrase': {'name': {'boost': 0.5, 'query': 'what is', 'slop': 2}}}, {'multi_match': {'fields': ['name', 'aliases.name'], 'query': 'what is', 'type': 'phrase_prefix'}}, {'match_phrase': {'name': {'boost': 0.5, 'query': 'is the', 'slop': 2}}}, {'multi_match': {'fields': ['name', 'aliases.name'], 'query': 'is the', 'type': 'phrase_prefix'}}, {'match_phrase': {'name': {'boost': 0.5, 'query': 'the mission', 'slop': 2}}}, {'multi_match': {'fields': ['name', 'aliases.name'], 'query': 'the mission', 'type': 'phrase_prefix'}}, {'match_phrase': {'name': {'boost': 0.5, 'query': 'mission of', 'slop': 2}}}, {'multi_match': {'fields': ['name', 'aliases.name'], 'query': 'mission of', 'type': 'phrase_prefix'}}, {'match_phrase': {'name': {'boost': 0.5, 'query': 'of the', 'slop': 2}}}, {'multi_match': {'fields': ['name', 'aliases.name'], 'query': 'of the', 'type': 'phrase_prefix'}}, {'match_phrase': {'name': {'boost': 0.5, 'query': 'the epa', 'slop': 2}}}, {'multi_match': {'fields': ['name', 'aliases.name'], 'query': 'the epa', 'type': 'phrase_prefix'}}]};
			assert.deepStrictEqual(actual, expected);
		});
	});
	...
	describe('#getQAEntities', function () {
		...
		it('should return the top matching entity (even if there is no alias in the query)', async () => {
			...
			const userId = 'fake-user';
			const target = new SearchUtility(tmpOpts);
			const result = await target.getQAEntities(qaQueries, bigramQueries, qaParams, esClientName, entitiesIndex, userId)
			const actual = result.allResults.body.hits.hits[0]
			const expected = {'_id': 'fGIhP3oBSijRXU555yQW', '_index': 'entities_20210624', '_score': 28.753735, '_source': {'address': 'Ariel Rios Building 1200 Pennsylvania Ave., NW Washington, DC 20460', 'aliases': [{'name': 'EPA'}], 'crawlers': '', 'entity_type': 'org', 'government_branch': 'Independent Agency', 'information': 'The Environmental Protection Agency (EPA) is an independent executive agency of the United States federal government tasked with environmental protection matters. President Richard Nixon proposed the establishment of EPA on July 9, 1970; it began operation on December 2, 1970, after Nixon signed an executive order. The order establishing the EPA was ratified by committee hearings in the House and Senate. The agency is led by its administrator, who is appointed by the president and approved by the Senate. The current Administrator is Michael S. Regan. The EPA is not a Cabinet department, but the administrator is normally given cabinet rank.The EPA has its headquarters in Washington, D.C., regional offices for each of the agency\'s ten regions, and 27 laboratories. The agency conducts environmental assessment, research, and education. It has the responsibility of maintaining and enforcing national standards under a variety of environmental laws, in consultation with state, tribal, and local governments. It delegates some permitting, monitoring, and enforcement responsibility to U.S. states and the federally recognized tribes. EPA enforcement powers include fines, sanctions, and other measures. The agency also works with industries and all levels of government in a wide variety of voluntary pollution prevention programs and energy conservation efforts.In 2018, the agency had 13,758 employees. More than half of EPA\'s employees are engineers, scientists, and environmental protection specialists; other employees include legal, public affairs, financial, and information technologists.Many public health and environmental groups advocate for the agency and believe that it is creating a better world. Other critics believe that the agency commits government overreach by adding unnecessary regulations on business and property owners.', 'information_retrieved': '2021-06-04', 'information_source': 'Wikipedia', 'name': 'Environmental Protection Agency', 'num_mentions': '', 'parent_agency': 'United States Government', 'related_agency': '  ', 'website': 'https://www.epa.gov/'}, '_type': '_doc', 'match': 'EPA'};
			assert.deepStrictEqual(actual, expected);
		});
	});
	...
	describe('#cleanQAResults', function () {
		...
		it('should format the results of QA', () => {
			...
			const expected = {'qaResults': {'answers': ['Increasing human resource team literacy'], 'docIds': ['S 3965 IS 116th.pdf_0'], 'filenames': ['Source: S. 3965 TO ACCELERATE THE APPLICATION OF ARTIFICIAL INTELLIGENCE IN THE DEPARTMENT OF DEFENSE AND TO STRENGTHEN THE WORKFORCE THAT PERTAINS TO ARTIFICIAL INTELLIGENCE, AND FOR OTHER PURPOSES. (DOCUMENT)'], 'resultTypes': ['document']}};
			assert.deepStrictEqual(actual, expected);
		});
	});
