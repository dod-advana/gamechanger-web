...
describe('SearchUtility', function () {
				...
				query: {
					bool: {
						...
						should: [
							...
							{ wildcard: { 'filename.search': { value: '*artificial intelligence*', boost: 5 } } },
							{
								wildcard: {
									'display_source_s.search': { value: '*artificial intelligence*', boost: 4 },
								},
							},
							{ wildcard: { 'top_entities_t.search': { value: '*artificial intelligence*', boost: 4 } } },
							{
								query_string: {
	...
	describe('#autocorrect', () => {
		...
		// 	const actual = target.autocorrect(data);
