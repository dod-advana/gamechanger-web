			...
			must: [
				...
				},
				{
					nested: {
						...
						query: {
							bool: {
								should: [{ match: { 'extracted_data_eda_n.dodaac_org_type_eda_ext': 'army' } }],
							},
						},
					},
				},
						...
						query: {
							bool: {
								must: [
									{
										match: {
											'extracted_data_eda_n.contract_issue_office_name_eda_ext': 'Dept of Army',
										},
									},
								],
							},
								...
								hits: [
									{
										...
										highlight: {
											'pages.p_raw_text': ['testing, and adjust units under <em>test</em>.'],
										},
									},
									{
										_index: 'gc_eda_2021_syn_pds',
	...
	docs: [
		{
			...
			pds_filename_eda_ext:
				'EDAPDS-59C397E8DE995F6AE05400215A9BA3BA-W911NF17D0002-0002-empty-empty-PDS-2017-09-22.json',
			pdf_contract_eda_ext: 'W911NF17D0002',
			filename: 'EDAPDF-59BE6A9B163C1247E05400215A9BA3BA-W911NF17D0002-0002-empty-empty-PDS-2017-09-21.pdf',
			pdf_grouping_eda_ext: 'pdf_log_217',
			pds_modification_eda_ext: 'empty',
			...
			clins: [
				{
					clin_num_eda_ext: 'test',
					unit_eda_ext: 'test',
					unit_price_eda_ext: 'test',
					amount_eda_ext: 'test',
					purchase_request_number_eda_ext: 'test',
					supplies_services_eda_ext: 'test',
					psc_code_eda_ext: 'test',
					naics_code_clin_eda_ext: 'test',
				},
			],
		},
	],
...
const mockPGResults = [
	{
		filename: 'EDAPDS-6EC18152407E0E7FE05400215A9BA3BA-FA807514D0016-FA807518F1670-empty-empty-PDS-2018-06-16.json',
