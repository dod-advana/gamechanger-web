		...
		docs: [
			{
				...
				pageHits: [
					{
						snippet:
							'addition to grilled sandwiches and the deli bar .Entrees may include other hot sandwiches such as the Sloppy Joe , Cannon Ball , and Fishwich or other popular short order entrees such as <em>pizza</em>',
						pageNumber: 116,
					},
				],
				pageHitCount: 1,
