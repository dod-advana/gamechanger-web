...
describe('JBookSearchHandler', function () {
	...
	describe('#searchHelper', () => {
		...
		it('should return data for a PG search', 
			async (done) => {
		...
		it('should return data for filters', 
			async (done) => {
				const req = {};
		...
		it('should return excel data for review status',
			async (done) => {
				let resStatus = false;
				let setHeader = 0;
				let resEnd = false;
				...
				try {
					...
					const expected = {
						results: {'totalCount':1,'docs':[{'type':'RDT&E','id':1,'keywords':['WORD;'],'contracts':['titles  piids  fys'],'accomplishments':['accomp titles'],'budgetType':'rdoc','hasKeywords':true}],'expansionDict':{}}						,
						counts: {'fy22':{'hasKeywords':{'army':{'total':0,'service':0,'poc':0,'finished':0},'af':{'total':0,'service':0,'poc':0,'finished':0},'navy':{'total':0,'service':0,'poc':0,'finished':0},'usmc':{'total':0,'service':0,'poc':0,'finished':0},'socom':{'total':0,'service':0,'poc':0,'finished':0},'osd':{'total':0,'service':0,'poc':0,'finished':0},'js':{'total':0,'service':0,'poc':0,'finished':0},'other':{'total':0,'service':0,'poc':0,'finished':0},'total':0,'service':0,'poc':0,'finished':0},'noKeywords':{'army':{'total':0,'service':0,'poc':0,'finished':0},'af':{'total':0,'service':0,'poc':0,'finished':0},'navy':{'total':0,'service':0,'poc':0,'finished':0},'usmc':{'total':0,'service':0,'poc':0,'finished':0},'socom':{'total':0,'service':0,'poc':0,'finished':0},'osd':{'total':0,'service':0,'poc':0,'finished':0},'js':{'total':0,'service':0,'poc':0,'finished':0},'other':{'total':0,'service':0,'poc':0,'finished':0},'total':0,'service':0,'poc':0,'finished':0}},'fy21':{'hasKeywords':{'army':{'total':0,'service':0,'poc':0,'finished':0},'af':{'total':0,'service':0,'poc':0,'finished':0},'navy':{'total':0,'service':0,'poc':0,'finished':0},'usmc':{'total':0,'service':0,'poc':0,'finished':0},'socom':{'total':0,'service':0,'poc':0,'finished':0},'osd':{'total':0,'service':0,'poc':0,'finished':0},'js':{'total':0,'service':0,'poc':0,'finished':0},'other':{'total':1,'service':1,'poc':0,'finished':0},'total':1,'service':1,'poc':0,'finished':0},'noKeywords':{'army':{'total':0,'service':0,'poc':0,'finished':0},'af':{'total':0,'service':0,'poc':0,'finished':0},'navy':{'total':0,'service':0,'poc':0,'finished':0},'usmc':{'total':0,'service':0,'poc':0,'finished':0},'socom':{'total':0,'service':0,'poc':0,'finished':0},'osd':{'total':0,'service':0,'poc':0,'finished':0},'js':{'total':0,'service':0,'poc':0,'finished':0},'other':{'total':0,'service':0,'poc':0,'finished':0},'total':0,'service':0,'poc':0,'finished':0}}}
					};
					assert.deepStrictEqual(actual, expected);
					assert.equal(resStatus, true);
					assert.equal(setHeader, 2);
					assert.equal(resEnd, true);
