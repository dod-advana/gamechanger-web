...
describe('JBookDataHandler', function () {
	...
	describe('#getProjectData', () => {
		...
		it ('should get the odoc project data for different types PG', async (done) => {
			...
			const expected = {'id':222,'appropriationNumber':'3400F','accountTitle':'Operation & Maintenance, Air Force','serviceAgency':'Air Force (AF)','budgetActivityNumber':'01','budgetActivityTitle':'Operating Forces','projectNum':'1F','projectTitle':'Air Operations','budgetLineItem':'010','programElement':'011A','budgetLineItemTitle':'Primary Combat Forces','include_in_toa':'Y','fy_2020_actual':'820,962','priorYearAmount':'709,228','fy_2021_request':'706,860','classification':'U','budgetYear':'2022','sag_budget_line_item_title_search':'\'combat\':2 \'forc\':3 \'primari\':1','contracts':[],'obligations':[],'keywords':[],'review':{'id':259162,'revProgramElement':'011A','revBudgetLineItems':'010','primaryClassLabel':'Unknown','primaryPlannedTransitionPartner':'Unknown','serviceAdditionalMissionPartners':'Unknown','reviewStatus':'Partial Review (Service)','budgetYear':'2022','budgetType':'odoc','primaryReviewStatus':'Finished Review','serviceReviewStatus':'Partial Review','primaryReviewer':'Srinivasan, Sridhar','serviceReviewer':'Chapa, Joseph (Air Force)','createdAt':'2021-11-10T13:59:29.065Z','updatedAt':'2021-11-10T13:59:29.065Z','budgetActivityNumber':'01','appropriationNumber':'3400F','serviceAgency':'Air Force (AF)','totalBudget':0,'primaryReviewerEmail':null,'serviceReviewerEmail':null,'serviceSecondaryReviewerEmail':null},'vendors':[]};
			const actual = await target.getProjectData(req, 'Test');
			assert.deepStrictEqual(actual, expected);
			done();
		});
		...
		it ('should get the pdoc project data for ES', async (done) => {
			...
			const expected = {'budgetType':'pdoc','key_s':'pdoc#2022#PB#07#000075#57#N/A#3010','currentYearAmount':'979.388','priorYearAmount':'1372.337','P40-77_TOA_PY':'1173.314','by1BaseYear':'979.388','budgetYear':'2022','appropriationNumber':'3010','appropriationTitle':'Aircraft Procurement, Air Force','budgetActivityNumber':'07','budgetActivityTitle':'Aircraft Supt Equipment & Facilities','budgetLineItem':'000075','projectTitle':'Other Production Charges','p1LineNumber':'85','projectMissionDescription':'The Miscellaneous Production Charges program provides for items which are not directly related to other procurement line items in this appropriation, cannot be reasonably allocated and charged to other procurement line items in this appropriation, can be managed as separate end items, may contain certain classified programs, and may be alternate mission equipment, not considered a modification, for out of production systems.\n\nThe major efforts supported in FY 2022 include funding for Electronic Attack pods, towed decoys and associated test equipment; B-2, F-15E, F-15 EPAWSS and F-22 Depot Core Activation, Aerial Targets, Maintenance Support Vehicles or Equipment and the required U.S. contribution for projects defined by the NATO Airborne Early Warning and Control (NAEWC) Board of Directors and approved by the U.S. government.  \n\nThe program has associated Research Development Test and Evaluation funding in PEs 0101113F, 0101127F, 0207040F, 0207171F, 0207134F, 0207138F, 0205219F, 0207249F, 0305116F, 0305220F, 0401119F, 0604735F, 0701212F and 1203001F.','P40-15_Justification':'This program, Other Production Charges P-40A Category Uncategorized Item Bomber Armament Tester (BAT), is a new start.\n\nThe major efforts supported in FY 2022 include funding for Electronic Attack pods, towed decoys and associated test equipment; B-2, F-15E and F-22 Depot Core Activation; RQ-4, and Aerial Targets.','serviceAgency':'Air Force (AF)','uot_department_s':'57','uot_agency_s':'N/A','P40-13_BSA_Title':'Other Production Charges','org_jbook_desc_s':'Air Force (AF)','org_code_s':'AF','id':'pdoc#000075#2022#3010#07#Air Force (AF)','p40a_aggregated_items_n':[{'P40a-16_Title_t':'F-22A'},{'P40a-16_Title_t':'F-15E Squadrons'},{'P40a-16_Title_t':'RQ-4 UAV'},{'P40a-16_Title_t':'Maintenance Support Vehicles or Equipment'},{'P40a-16_Title_t':'F-15A/B/C/D Squadrons'},{'P40a-16_Title_t':'Supply Depot Operations (Non-IF)'},{'P40a-16_Title_t':'PRECISION ATTACK SYSTEMS PROCUREMENT'},{'P40a-16_Title_t':'EWIR'},{'P40a-16_Title_t':'TRGT'},{'P40a-16_Title_t':'MQ-9'},{'P40a-16_Title_t':'EW POD'},{'P40a-16_Title_t':'CTRE'},{'P40a-16_Title_t':'F-15 EPAWSS'},{'P40a-16_Title_t':'Service Support to NATO AEWC Program'},{'P40a-16_Title_t':'Classified Mods'},{'P40a-16_Title_t':'B-2'},{'P40a-16_Title_t':'FBLOST'},{'P40a-16_Title_t':'C-5 Airlift Squadrons (IF)'}],'keywords':[],'hasKeywords':false,'pageHits':[],'review':{'id':233170,'revBudgetLineItems':'000073','serviceAgreeLabel':'Yes','primaryClassLabel':'Not AI','primaryPlannedTransitionPartner':'Air Force','servicePTPAgreeLabel':'Yes','serviceAdditionalMissionPartners':'Unknown','reviewStatus':'Partial Review (POC)','servicePOCTitle':'Superwoman','servicePOCName':'Elizabeth','servicePOCEmail':'hedrick_elizabeth@bah.com','primaryReviewNotes':'Test Automation Primary Reviewer Notes','budgetYear':'2022','budgetType':'pdoc','primaryReviewStatus':'Finished Review','serviceReviewStatus':'Partial Review','pocReviewStatus':'Partial Review','primaryReviewer':'Allen, Gregory','serviceReviewer':'Chapa, Joseph (Air Force)','servicePOCOrg':'Advana','servicePOCPhoneNumber':'867-5309','createdAt':'2021-11-10T13:59:27.983Z','updatedAt':'2022-03-08T03:33:44.950Z','budgetActivityNumber':'07','pocAgreeLabel':'No','pocClassLabel':'Not AI','pocPTPAgreeLabel':'Yes','pocMPAgreeLabel':'Yes','pocMissionPartnersChecklist':'{}','serviceMissionPartnersChecklist':'{}','appropriationNumber':'3010F','serviceAgency':'Air Force (AF)','totalBudget':0,'primaryReviewerEmail':null,'serviceReviewerEmail':null,'serviceSecondaryReviewerEmail':null}};
			const actual = await target.getProjectData(req, 'Test');
			assert.deepStrictEqual(actual, expected);
			done();
		});
		...
		it ('should get the rdoc project data for ES', async (done) => {
			...
			const expected = {'budgetType':'pdoc','key_s':'pdoc#2022#PB#07#000075#57#N/A#3010','currentYearAmount':'979.388','priorYearAmount':'1372.337','P40-77_TOA_PY':'1173.314','by1BaseYear':'979.388','budgetYear':'2022','appropriationNumber':'3010','appropriationTitle':'Aircraft Procurement, Air Force','budgetActivityNumber':'07','budgetActivityTitle':'Aircraft Supt Equipment & Facilities','budgetLineItem':'000075','projectTitle':'Other Production Charges','p1LineNumber':'85','projectMissionDescription':'The Miscellaneous Production Charges program provides for items which are not directly related to other procurement line items in this appropriation, cannot be reasonably allocated and charged to other procurement line items in this appropriation, can be managed as separate end items, may contain certain classified programs, and may be alternate mission equipment, not considered a modification, for out of production systems.\n\nThe major efforts supported in FY 2022 include funding for Electronic Attack pods, towed decoys and associated test equipment; B-2, F-15E, F-15 EPAWSS and F-22 Depot Core Activation, Aerial Targets, Maintenance Support Vehicles or Equipment and the required U.S. contribution for projects defined by the NATO Airborne Early Warning and Control (NAEWC) Board of Directors and approved by the U.S. government.  \n\nThe program has associated Research Development Test and Evaluation funding in PEs 0101113F, 0101127F, 0207040F, 0207171F, 0207134F, 0207138F, 0205219F, 0207249F, 0305116F, 0305220F, 0401119F, 0604735F, 0701212F and 1203001F.','P40-15_Justification':'This program, Other Production Charges P-40A Category Uncategorized Item Bomber Armament Tester (BAT), is a new start.\n\nThe major efforts supported in FY 2022 include funding for Electronic Attack pods, towed decoys and associated test equipment; B-2, F-15E and F-22 Depot Core Activation; RQ-4, and Aerial Targets.','serviceAgency':'Air Force (AF)','uot_department_s':'57','uot_agency_s':'N/A','P40-13_BSA_Title':'Other Production Charges','org_jbook_desc_s':'Air Force (AF)','org_code_s':'AF','id':'pdoc#000075#2022#3010#07#Air Force (AF)','p40a_aggregated_items_n':[{'P40a-16_Title_t':'F-22A'},{'P40a-16_Title_t':'F-15E Squadrons'},{'P40a-16_Title_t':'RQ-4 UAV'},{'P40a-16_Title_t':'Maintenance Support Vehicles or Equipment'},{'P40a-16_Title_t':'F-15A/B/C/D Squadrons'},{'P40a-16_Title_t':'Supply Depot Operations (Non-IF)'},{'P40a-16_Title_t':'PRECISION ATTACK SYSTEMS PROCUREMENT'},{'P40a-16_Title_t':'EWIR'},{'P40a-16_Title_t':'TRGT'},{'P40a-16_Title_t':'MQ-9'},{'P40a-16_Title_t':'EW POD'},{'P40a-16_Title_t':'CTRE'},{'P40a-16_Title_t':'F-15 EPAWSS'},{'P40a-16_Title_t':'Service Support to NATO AEWC Program'},{'P40a-16_Title_t':'Classified Mods'},{'P40a-16_Title_t':'B-2'},{'P40a-16_Title_t':'FBLOST'},{'P40a-16_Title_t':'C-5 Airlift Squadrons (IF)'}],'keywords':[],'hasKeywords':false,'pageHits':[],'review':{'id':239868,'revProgramElement':'0101122F','revBudgetLineItems':'674797','serviceAgreeLabel':'No','primaryClassLabel':'Core AI','primaryPlannedTransitionPartner':'Army','servicePTPAgreeLabel':'Yes','reviewStatus':'Partial Review (Service)','servicePOCTitle':'John','servicePOCName':'Doe','servicePOCEmail':'jdoe@yahoo.com','budgetYear':'2022','budgetType':'rdoc','primaryReviewStatus':'Finished Review','serviceReviewStatus':'Partial Review','primaryReviewer':'Allen, Gregory','serviceReviewer':'Chapa, Joseph (Air Force)','pocDollarsAttributed':'0.54','servicePOCOrg':'TIAA','servicePOCPhoneNumber':'8888675309','serviceClassLabel':'AI Enabled','createdAt':'2021-11-10T13:59:28.506Z','updatedAt':'2021-12-22T15:45:08.507Z','budgetActivityNumber':'07','pocAgreeLabel':'Yes','pocPTPAgreeLabel':'Yes','pocMPAgreeLabel':'Yes','appropriationNumber':'3600','serviceAgency':'Air Force (AF)','totalBudget':0,'primaryReviewerEmail':null,'serviceReviewerEmail':null,'serviceSecondaryReviewerEmail':null}};
			const actual = await target.getProjectData(req, 'Test');
			assert.deepStrictEqual(actual, expected);
			done();
		});
		...
		it ('should get the odoc project data for ES', async (done) => {
			...
			const expected = {'budgetType':'pdoc','key_s':'pdoc#2022#PB#07#000075#57#N/A#3010','currentYearAmount':'979.388','priorYearAmount':'1372.337','P40-77_TOA_PY':'1173.314','by1BaseYear':'979.388','budgetYear':'2022','appropriationNumber':'3010','appropriationTitle':'Aircraft Procurement, Air Force','budgetActivityNumber':'07','budgetActivityTitle':'Aircraft Supt Equipment & Facilities','budgetLineItem':'000075','projectTitle':'Other Production Charges','p1LineNumber':'85','projectMissionDescription':'The Miscellaneous Production Charges program provides for items which are not directly related to other procurement line items in this appropriation, cannot be reasonably allocated and charged to other procurement line items in this appropriation, can be managed as separate end items, may contain certain classified programs, and may be alternate mission equipment, not considered a modification, for out of production systems.\n\nThe major efforts supported in FY 2022 include funding for Electronic Attack pods, towed decoys and associated test equipment; B-2, F-15E, F-15 EPAWSS and F-22 Depot Core Activation, Aerial Targets, Maintenance Support Vehicles or Equipment and the required U.S. contribution for projects defined by the NATO Airborne Early Warning and Control (NAEWC) Board of Directors and approved by the U.S. government.  \n\nThe program has associated Research Development Test and Evaluation funding in PEs 0101113F, 0101127F, 0207040F, 0207171F, 0207134F, 0207138F, 0205219F, 0207249F, 0305116F, 0305220F, 0401119F, 0604735F, 0701212F and 1203001F.','P40-15_Justification':'This program, Other Production Charges P-40A Category Uncategorized Item Bomber Armament Tester (BAT), is a new start.\n\nThe major efforts supported in FY 2022 include funding for Electronic Attack pods, towed decoys and associated test equipment; B-2, F-15E and F-22 Depot Core Activation; RQ-4, and Aerial Targets.','serviceAgency':'Air Force (AF)','uot_department_s':'57','uot_agency_s':'N/A','P40-13_BSA_Title':'Other Production Charges','org_jbook_desc_s':'Air Force (AF)','org_code_s':'AF','id':'pdoc#000075#2022#3010#07#Air Force (AF)','p40a_aggregated_items_n':[{'P40a-16_Title_t':'F-22A'},{'P40a-16_Title_t':'F-15E Squadrons'},{'P40a-16_Title_t':'RQ-4 UAV'},{'P40a-16_Title_t':'Maintenance Support Vehicles or Equipment'},{'P40a-16_Title_t':'F-15A/B/C/D Squadrons'},{'P40a-16_Title_t':'Supply Depot Operations (Non-IF)'},{'P40a-16_Title_t':'PRECISION ATTACK SYSTEMS PROCUREMENT'},{'P40a-16_Title_t':'EWIR'},{'P40a-16_Title_t':'TRGT'},{'P40a-16_Title_t':'MQ-9'},{'P40a-16_Title_t':'EW POD'},{'P40a-16_Title_t':'CTRE'},{'P40a-16_Title_t':'F-15 EPAWSS'},{'P40a-16_Title_t':'Service Support to NATO AEWC Program'},{'P40a-16_Title_t':'Classified Mods'},{'P40a-16_Title_t':'B-2'},{'P40a-16_Title_t':'FBLOST'},{'P40a-16_Title_t':'C-5 Airlift Squadrons (IF)'}],'keywords':[],'hasKeywords':false,'pageHits':[],'review':{'id':259162,'revProgramElement':'011A','revBudgetLineItems':'010','primaryClassLabel':'Unknown','primaryPlannedTransitionPartner':'Unknown','serviceAdditionalMissionPartners':'Unknown','reviewStatus':'Partial Review (Service)','budgetYear':'2022','budgetType':'odoc','primaryReviewStatus':'Finished Review','serviceReviewStatus':'Partial Review','primaryReviewer':'Srinivasan, Sridhar','serviceReviewer':'Chapa, Joseph (Air Force)','createdAt':'2021-11-10T13:59:29.065Z','updatedAt':'2021-11-10T13:59:29.065Z','budgetActivityNumber':'01','appropriationNumber':'3400F','serviceAgency':'Air Force (AF)','totalBudget':0,'primaryReviewerEmail':null,'serviceReviewerEmail':null,'serviceSecondaryReviewerEmail':null}};
			const actual = await target.getProjectData(req, 'Test');
			assert.deepStrictEqual(actual, expected);
			done();
		});
