...
describe('EDAExportHandler', function () {
	describe('#exportHandler', () => {
		it('should export a file based on search data', async (done) => {
						...
						must: [
							...
							},
							{
								nested: {
									...
									query: {
										bool: {
											should: [
												{ match: { 'extracted_data_eda_n.dodaac_org_type_eda_ext': 'army' } },
											],
										},
									},
								},
							...
							},
							{
								nested: {
									...
									query: {
										range: {
											'extracted_data_eda_n.signature_date_eda_ext_dt': { gte: '2017-06-10' },
										},
									},
								},
							},
			...
			const mockESResults = {
				...
				statusCode: 200,
				headers: {
					date: 'Fri, 14 May 2021 00:48:42 GMT',
			...
			const mockPGResults = [
				{
					filename:
						'EDAPDS-6EC18152407E0E7FE05400215A9BA3BA-FA807514D0016-FA807518F1670-empty-empty-PDS-2018-06-16.json',
					prod_or_svc: 'Services',
					prod_or_svc_desc:
						'Labor & ODCs This CLIN is for non-personal research, development, test, and evaluation (RDT&E) TATs within the scope of the DS TATS PWS DT 17-1670, titled “Survivability and Vulnerability Technical Analyses for Navy Warfare Development Command for Operational Readiness, Training, and Experimentation.',
					li_base: '0002',
					li_type: 'CLIN',
					obligated_amount: null,
					obligated_amount_cin: null,
					row_id: '73220198bc8b02f58f219e1eb3725275ea148c50',
					all_outgoing_counts_pdf_pds_xwalk_only: {
						pdf_filename:
							'EDAPDF-6EEEC741A5B56B97E05400215A9BA3BA-FA807514D0016-FA807518F1670-empty-empty-PDS-2018-06-18.pdf',
						pds_filename:
							'EDAPDS-6EC18152407E0E7FE05400215A9BA3BA-FA807514D0016-FA807518F1670-empty-empty-PDS-2018-06-16.json',
					},
					pdf_filename:
			...
			const expectedResults =
				'Filename,Contract Number,Page Count,Issuing Organization,PCS Code,PSC Description,Obligated Amount,Clin Number,Unit,Unit Price,Amount,Purchase Request Number,Supply Services,Clin PCS Code,NAICSEDAPDF-59BE6A9B163C1247E05400215A9BA3BA-W911NF17D0002-0002-empty-empty-PDS-2017-09-21.pdf,W911NF17D0002-0002,48,Army,,,6472000';
			// 'Filename,Contract Number,Page Count,Issuing Organization,PCS Code,PSC Description,Obligated Amount,Clin Number,Unit,Unit Price,Purchase Request Number,Supply Services,NAICSEDAPDF-59BE6A9B163C1247E05400215A9BA3BA-W911NF17D0002-0002-empty-empty-PDS-2017-09-21.pdf,W911NF17D0002-0002,48,Army,,,6472000';
			try {
