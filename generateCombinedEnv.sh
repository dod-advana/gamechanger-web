...
EDA_OPENSEARCH_HOST="${EDA_OPENSEARCH_HOST:-elasticsearch}"
EDA_OPENSEARCH_PORT="${EDA_OPENSEARCH_PORT:-9200}"
EDA_OPENSEARCH_USER="${EDA_OPENSEARCH_USER:-}"
EDA_OPENSEARCH_PASSWORD="${EDA_OPENSEARCH_PASSWORD:-}"
EDA_OPENSEARCH_CA_FILEPATH="${EDA_OPENSEARCH_CA_FILEPATH:-/etc/secrets/gamechanger.crt}"
EDA_OPENSEARCH_INDEX="${EDA_OPENSEARCH_INDEX:-gc_eda_2021_json}"
EDA_OPENSEARCH_PROTOCOL="${EDA_OPENSEARCH_PROTOCOL:-http}"
