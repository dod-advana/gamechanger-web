...
var PDFViewerApplication = {
  ...
  download: function download() {
    ...
    var filename = this.filename || this.contentDispositionFilename || (0, _ui_utils.getPDFFileNameFromURL)(this.url);
...
function webViewerInitialized() {
  ...
  filename = typeof document.location.hash === 'string' && document.location.hash.includes('filename=')
...
{
  webViewerOpenFileViaURL = function webViewerOpenFileViaURL(file, filename = '') {
    if (file && file.lastIndexOf('file:', 0) === 0) {
      PDFViewerApplication.setTitleUsingUrl(file);
      var xhr = new XMLHttpRequest();

      xhr.onload = function () {
        PDFViewerApplication.open(new Uint8Array(xhr.response), { filename });
      };
