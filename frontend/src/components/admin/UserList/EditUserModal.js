...
const tabList = [
	{
		title: 'userData',
		onClick: () => {},
		children: <Typography variant="h6" display="inline" title="cardView">User Data</Typography>
	},
	{
			...
			<DialogContent style={{ height: '100%', width: 1200 }}>
				<div style={{ margin: '0 20px' }}>
					<Grid container style={{ background: '#f2f2f2', borderRadius: 6, marginTop: 10, marginBottom: 10, padding: 10 }}>
						<Typography style={{ fontFamily: 'Montserrat', fontSize: 16 }}>Edit the fields below to update user permissions and general user data</Typography>
					</Grid>
