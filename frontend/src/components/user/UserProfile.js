		...
		return (
			<>
				<FormControl className={'input-field'}>
					<InputLabel shrink htmlFor="name-input" className={classes.inputLabel}>Name</InputLabel>
					<Input
						id={'name-input'}
				...
				<FormControl className={'input-field'}>
					<InputLabel shrink htmlFor="job-title-input" className={classes.inputLabel}>Job Title</InputLabel>
					<Input
						id={'job-title-input'}
						className={classes.inputBox}
						startAdornment={
				...
				<FormControl className={'input-field'}>
					<InputLabel shrink htmlFor="email-address-input" className={classes.inputLabel}>Email Address</InputLabel>
					<Input
				...
				<FormControl className={'input-field'}>
					<InputLabel shrink htmlFor="phone-number-input" className={classes.inputLabel}>Phone Number</InputLabel>
					<Input
				...
				<FormControl className={'input-field'}>
					<InputLabel shrink htmlFor="organization-input" className={classes.inputLabel}>Organization</InputLabel>
					<Input
				...
				<FormControl className={'input-field'}>
					<InputLabel shrink htmlFor="work-location-input" className={classes.inputLabel}>Work Location</InputLabel>
					<Input
						...
						value={`${userData.country || ''}${userData.state ? `, ${userData.state}` : ''}${userData.city ? `, ${userData.city}` : ''}`}
						disabled={true}
					/>
				</FormControl>
			</>
					...
					<Grid container item xs={3} justify="center" alignItems="center" >
						<StyledUserProfileDataDiv>
							<Grid direction={'column'} container justify="center" alignItems="center" className={'user-picture'}>
								...
								<Typography className={'user-name'}>{userData.preferred_name || `${userData.first_name || ''} ${userData.last_name || ''}`}</Typography>
							</Grid>
							...
							<Grid direction={'column'} container justify="center" alignItems="center" className={'user-edit-button'}>
								<UserEditButton
									variant="outlined"
									startIcon={<EditIcon />}
