...
const GCUserDashboard = (props) => {
	...
	const [
		searchHistorySettingsPopperAnchorEl,
		setSearchHistorySettingsPopperAnchorEl,
	] = useState(null);
	const [searchHistorySettingsPopperOpen, setSearchHistorySettingsPopperOpen] =
		useState(false);
		...
		return (
			<div style={{ width: '100%', height: '100%' }}>
				{favoriteDocumentsLoading ? (
					...
					<StyledPlaceHolder>
						Favorite a document to see it listed here
					</StyledPlaceHolder>
				)}
		...
		<div style={styles.tabContainer}>
			...
			>
				...
				<div style={styles.panelContainer}>
					<TabPanel>{renderFavorites()}</TabPanel>
					<TabPanel>{renderHistory()}</TabPanel>
				</div>
			</Tabs>
		</div>
	);
