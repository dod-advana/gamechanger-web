...
const GroupFavoriteCard = (props) => {
	...
	return (
		<StyledFavoriteDocumentCard
			...
			style={active ? { height: 500, top: 0 } : {}}
		>
			<div className={'main-info'}>
				<div className={'top-buttons'}>
					<div className={'back-button'} onClick={() => setActive(false)}>
						{'< Back'}
					</div>
							...
							<div style={{ padding: '0px 15px 10px' }}>
								...
								<div style={{ width: 350, margin: 5 }}>
									<div style={{ margin: '65px 15px 0' }}>
										Are you sure you want to remove this favorite from the group?
									</div>
									<div style={{ display: 'flex', justifyContent: 'flex-end' }}>
										<GCButton
