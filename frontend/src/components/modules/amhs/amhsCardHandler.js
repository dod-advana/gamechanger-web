...
const auxDisplayBackFields = ['To', 'TOR', 'DTG', 'DAC', 'Prec', 'pages', 'classification'];
const auxDisplayTitleField = 'title';
const auxDisplayFrontFields = ['Originator', 'DAC', 'Body'];
...
export default AmhsCardHandler;
