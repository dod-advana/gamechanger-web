	...
	return {
		...
		toolLogo: (
			<div>
				...
				<Typography variant="h6" style={{ ...styles.wording, textAlign: 'center', margin: '0 15px 0 0'}}>
			...
			<div style={{ display: 'flex', flexDirection: 'column' }}>
				...
				{state.cloneData?.show_crowd_source &&
					<GCTooltip title="Help us verify data" placement="right" arrow>
						...
						>
							<ConstrainedIcon src={CrowdSourcingAppIcon}/><span
							style={{marginLeft: '10px'}}>Crowd Sourcing</span>
						</HoverNavItem>
					</GCTooltip>
				}
				{state.cloneData?.show_data_tracker &&
