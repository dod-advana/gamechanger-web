...
import {
	handleSaveFavoriteDocument, setState
				...
				<Fade in={feedback === ''} timeout={ 1500 }>
					<div style={{flexGrow: 2, display: 'flex', }}>
						<i
							...
							style={{color: feedback === 'thumbsUp' ? '#238823' : 'white', marginRight: '10px'}}
							onClick={() => {
								if(feedback === ''){
		...
		return 	(
			<div style={styles.intelligentContainer}>
				<div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
					<div>
						<div style={styles.bold}> DOCUMENT {' '} {intelligentSearchResult.display_title_s} <span style={{fontSize: '0.8em', color: 'gray'}}>({intelligentSearchResult.display_org_s})</span></div>
					...
					<div style={styles.flex}>
							...
							{isFavorite ?
								<div style={{padding: '0px 15px 10px'}}>
									...
									<div style={{width: 350, margin: 5}}>
										<div style={{margin: '65px 15px 0'}}>Are you sure you want to delete this favorite? You will
								...
								<div className={classes.paper}>
									<div style={{width: 330, margin: 5, display: 'flex', flexDirection: 'column'}}>
										<TextField
						...
						<div style={styles.flex}>	
						{checkboxComponent(intelligentSearchResult.filename, intelligentSearchResult.display_title_s)}
						{favoriteComponent()}
