...
export const RespExplAnnotationCard = ({
	text,
	tags,
	currentTokens,
	setCurrentTokens,
	...
	return (
		<div className={`tutorial-step-${componentStepNumbers['Crowd Assist Panel']}`}>
			<div className={'section'}>
				<GCAccordion expanded={true} header={'How to use this tool:'} backgroundColor={'rgb(238,241,242)'}>
					<ol style={{ margin: 0, padding: '0 18px', fontWeight: 600 }}>
						<li style={{ textAlign: 'justify' }}>
							If this line was improperly labelled as a Responsibility, select the No Responsibility
							button; otherwise:
						</li>
						<li style={{ textAlign: 'justify' }}>Select an Hightlight Type.</li>
						<li style={{ textAlign: 'justify' }}>
							Highlight words, sentences, or parts of text that apply.
						</li>
						<li style={{ textAlign: 'justify' }}>Submit to tag the text with for review.</li>
					</ol>
				</GCAccordion>
			</div>
			...
			<div className={'row'} style={{ margin: '15px 0 ' }}>
				<div className={'row'}>
					<Typography variant="h5" display="outline" style={{ margin: '15px 5px 0 15px' }}>
						Highlight text for:
					</Typography>
					<RadioGroup
						row
			...
			<GCButton
				className={'row'}
				style={{ height: '25%', width: '100%', margin: '0 0' }}
				id={'gcAssistAbove'}
				onClick={() => {
					moreTextClick(-1);
				}}
