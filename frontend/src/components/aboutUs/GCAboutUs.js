			...
			<div style={{ margin: '0 0px 30px 100px', display: 'flex' }}>
				...
				>
					...
					<Typography variant="body" display="block">
						Today, tens of thousands of documents govern how the Department of Defense
						(DoD) operates. The documents exist in different repositories, often exist
						on different networks, are discoverable to different communities, are
						updated independently, and evolve rapidly. No single ability has ever
						existed that would enable navigation of the vast universe universe of
						governing requirements and guidance documents, leaving the Department
						unable to make evidence-based, data-driven decisions. Today, merely one
						year into development, GAMECHANGER offers a scalable solution with with an
						authoritative corpus comprising a single trusted repository of all
						statutory and policy driven requirements based on Artificial-Intelligence
					...
					<Typography variant="body" style={{ marginTop: '10px' }}>
						<b>Vision: </b>To fundamentally change the way in which the Department
						navigates its universe of requirements and makes decisions
					</Typography>
					<Typography variant="body" style={{ marginTop: '10px' }}>
						<b>Mission: </b>To create a trusted Department-wide solution for
						evidence-based, data-driven decision making across the universe of DoD
						requirements, by:
						<br />• Building the Department’s authoritative corpus of requirements and
						policy to drive search, discovery, understanding, and analytic
						capabilities <br />• Operationalizing cutting-edge technologies,
						algorithms, models, and interfaces to automate and scale the solution{' '}
						<br />• Fusing best practices from industry, academia, and government to
						advance innovation and research <br />• Engaging the open-source community
						to build generalizable and replicable technology
					</Typography>
				</div>
				<img
					...
					<div style={styles.iconContainer}>
						...
						<div>
							<Typography variant="body">
								...
								governing requirements built using AI-enabled technologies, including
								Natural Language Processing (NLP), and using generalizable data
								engineering pipelines for a variety of data formats
							</Typography>
						</div>
					</div>
					<div style={styles.iconContainer}>
						...
						<div>
							<Typography variant="body">
								...
								<br />
								Queries the policy corpus to identify relevant requirements based on
								exact words, phrases, and/or semantic context to identify applicable
								responsibilities, functions, strategies, and more
							</Typography>
						</div>
					</div>
					<div style={styles.iconContainer}>
						...
						<div>
							<Typography variant="body">
								...
								interdependencies, connection points, redundancies, and/or
					...
					<div style={styles.iconContainer}>
						...
						<div>
							<Typography variant="body">
								<b>Built to Scale</b>
								<br />
								Enables application cloning to facilitate new use cases, operationalizes
								open-source technology, and exposes application programming interfaces
								to stakeholders
							</Typography>
						</div>
					</div>
					<div style={styles.iconContainer}>
						...
						<div>
							<Typography variant="body">
								...
								<br />
								Ensures linked data is never out of sync by leveraging an agile machine
								learning operations (MLOps) process to continually refine NLP
								technologies, including AI and machine learning capabilities, which
								train automation models to identify, aggregate, ingest, and integrate
								data sources
							</Typography>
						</div>
					</div>
			...
			<div style={{ backgroundColor: '#0000000A' }}>
				...
				>
					...
					<div style={{ marginLeft: '30px' }}>
						...
						<Typography variant="body">
							GAMECHANGER enhances insights and refines processes by changing the way
							in which users interact with the policy domain:
							<br />
							...
							<br />
							• Understand financial implications of proposed changes or revisions to
							existing policy
							<br />
							• Identify budget efficiencies by streamlining policy and de-conflicting
							requirements <br />
							<br />
							...
							<br />
							• Develop code collaboratively among DoD civilians, military personnel,
	...
	const renderFAQ = () => {
		return [
			<div style={{ margin: '0 0 30px 100px' }}>
				...
				<Typography variant="body">
					Browse our answers to some of your most frequently asked questions. We’ll
					continually update this page with new insights and information, so check
					back often.
				</Typography>
			</div>,
