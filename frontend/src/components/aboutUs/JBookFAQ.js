		...
		const categorized = {
			general: [
				...
				},
				{
					...
					<br />
					<br />Upon logging in, click on the Reviewer Checklist Tab. On this tab, you will find the projects you are supposed to review. Double click on an individual Project line, and you will be taken to the Project Profile page. Read the Project Description (and any AI related key words in highlighted text), the General Ledger, Accomplishments and Contracts information as well as the Initial Reviewer section. Then scroll down to the Service Reviewer section. In this section you can review and accept or reject the accuracy of the JAIC’s findings about the project in question.   
					<br />
					<br />The initial reviewer name will prepopulate based on your service. If desired, enter a RAI reviewer name in the text box labeled RAI Reviewer. Use the drop downs to select if you agree with the JAICs determination regarding whether or not the project is Core AI, AI Enabled, AI enabling or not AI. Definitions for each of these terms can be found by hovering over the relevant text next to the drop down. If you do not agree with the JAICs determination, enter whether the project is Core AI, AI Enabled, AI enabling or not AI in the relevant drop down.  
					<br />
