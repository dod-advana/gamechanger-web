		...
		const categorized = {
			general: [
				...
				},
				{
					...
					<br />
					<br />Upon logging in, click on the Reviewer Checklist Tab. On this tab, you will find the projects you are supposed to review. Double click on an individual Project line, and you will be taken to the Project Profile page. Read the Project Description (and any AI related key words in highlighted text), the General Ledger, Accomplishments and Contracts information as well as the Initial Reviewer section. Then scroll down to the RAI Lead Reviewer section. In this section you can review and accept or reject the accuracy of the JAIC’s findings about the project in question.   
					<br />
					<br />The initial reviewer name will prepopulate based on your service. If desired, enter a secondary reviewer name in the text box labeled secondary Reviewer. Use the drop downs to select if you agree with the JAICs determination regarding whether or not the project is Core AI, AI Enabled, AI enabling or not AI. Definitions for each of these terms can be found by hovering over the relevant text next to the drop down. If you do not agree with the JAICs determination, enter whether the project is Core AI, AI Enabled, AI enabling or not AI in the relevant drop down.  
					<br />
					<br />Finally, add the project POC, POC Organization, POC title and POC email in the text boxes provided. A suitable type of PoC would be the Program Element Monitor. Add any other relevant information to the Reviewer Notes Text Box. Once all these tasks are complete click on the submit button at the bottom of the RAI Lead Reviewer section. If you need to revise a submitted set of information on a project, click on the reset button at the bottom of the RAI Lead Reviewer section. Close this page when complete and go back to the Reviewer Checklist page to select the next project for review.
				`),
					question: 'How Does the Tool Work for Service Level Reviewers?',
				},
				{
					answer: anchorme(`Upon logging in, click on the Reviewer Checklist Tab. On this tab, you will find the projects you are supposed to review. Double click on an individual Project line, and you will be taken to the Project Profile page. Read the Project Description (and any AI related key words in highlighted text), the General Ledger, and Contracts information as well as the Initial and RAI Lead Reviewer sections. Then scroll down to the POC Reviewer section.  
					<br />
					<br />If you are not the appropriate POC for this Program/Project, please enter an alternate AI Point of Contact for this Program/Project in the POC section of the RAI Lead Reviewer Section. We ask that you enter the Alternate POC Title, Name, Email address, Organization and Phone number in this section.    
					<br />
					...
					<br />
					<br />Once all these tasks are complete click on the submit button at the bottom of the RAI Lead Reviewer section. If you need to revise a submitted set of information on a project, click on the reset button at the bottom of the POCReviewer section. Close this page when complete and go back to the Reviewer Checklist page to select the next project for review.
				`),
