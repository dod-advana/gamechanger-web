...
const DialogTitle = withStyles(muiStyles)((props) => {
	...
	return (
		<MuiDialogTitle disableTypography className={classes.root} {...other}>
			<Typography variant="h3" style={{ marginTop: 10, marginLeft: 10 }}>{children}</Typography>
			{onClose &&
...
export default function BetaModal({
	...
	return <div>
		<Dialog maxWidth={'md'} onClose={onCancelClick} open={open}>
			<DialogTitle onClose={onCancelClick}>
				Try Beta Version!
			</DialogTitle>
			<DialogContent>
				<div style={contentStyle}>
					<Typography variant="body2">Would you like to try this app with the new Beta Version?</Typography>
				</div>
			</DialogContent>
			<DialogActions>
